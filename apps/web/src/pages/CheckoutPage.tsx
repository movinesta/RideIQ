      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="card p-5 space-y-3">
          ...
          <div className="pt-2 flex items-center justify-between">
            ...
            <div className="font-semibold">{formatIQD(subtotal)}</div>
          </div>
          <div className="text-xs text-gray-500">Final totals are calculated on the server (promotions may apply).</div>
