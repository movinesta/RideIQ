      ...
      <RoleGate>
        <Layout>
          <Routes>
            ...
            <Route path="/admin/service-areas" element={<AdminServiceAreasPage />} /><Route path="/admin/merchants" element={<AdminMerchantsPage />} />
...
export default function App() {
  return (
    <Routes>
      <Route path="/share/:token" element={<ShareTripPage />} /><Route path="/family/invite/:token" element={<TeenInvitePage />} />
