...
export type MerchantOrderDeliveryStatus = 'requested' | 'assigned' | 'picked_up' | 'delivered' | 'cancelled';
...
export async function setDeliveryStatus(deliveryId: string, status: MerchantOrderDeliveryStatus) {
