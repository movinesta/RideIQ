    ...
    <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          <Pill to="/admin/settlements" active={loc.pathname.startsWith('/admin/settlements')}>Settlements</Pill>
          <Pill to="/admin/agents" active={loc.pathname.startsWith('/admin/agents')}>Agents</Pill>
          <Pill to="/admin/commissions" active={loc.pathname.startsWith('/admin/commissions')}>Commissions</Pill>
          ...
          <Pill to="/admin/pricing" active={loc.pathname.startsWith('/admin/pricing')}>Pricing</Pill>
	          <Pill to="/admin/fare-quotes" active={loc.pathname.startsWith('/admin/fare-quotes')}>Fare Quotes</Pill><Pill to="/admin/service-areas" active={loc.pathname.startsWith('/admin/service-areas')}>Service Areas</Pill>
          ...
          <Pill to="/admin/settings" active={loc.pathname.startsWith('/admin/settings')}>Settings</Pill>
        </div>
      </div>
    </div>
  );
