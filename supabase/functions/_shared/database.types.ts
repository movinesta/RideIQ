...
export type Database = {
  public: {
    Enums: {
      ...
      contact_channel: 'whatsapp' | 'sms' | 'webhook';
      ...
      ride_intent_source: 'whatsapp' | 'callcenter';
      ...
      whatsapp_thread_op_status: 'open' | 'waiting_user' | 'waiting_operator' | 'resolved';
      whatsapp_thread_stage: 'awaiting_pickup' | 'awaiting_dropoff' | 'ready' | 'closed';
    ...
    Tables: {
      ...
      whatsapp_messages: {
        Row: {
          ...
          wa_status: Database['public']['Enums']['whatsapp_message_status'] | null;
        };
        Insert: {
          body?: string | null;
          created_at?: string;
      ...
      whatsapp_threads: {
        Row: {
          ...
          last_failed_outbound_message_id: string | null;
          last_inbound_at: string | null;
          last_message_at: string | null;
          last_outbound_at: string | null;
          needs_followup: boolean;
          op_status: Database['public']['Enums']['whatsapp_thread_op_status'];
          phone_e164: string | null;
          pickup_address: string | null;
          pickup_lat: number | null;
          pickup_lng: number | null;
          stage: Database['public']['Enums']['whatsapp_thread_stage'];
          updated_at: string;
          wa_id: string;
        };
        Insert: {
    ...
    Functions: {
      ...
      whatsapp_booking_token_view_v1: {
        Args: {
          p_token: string;
        };
        Returns: unknown;
      };
      whatsapp_booking_tokens_cleanup_v1: {
        Args: {
          p_limit: number;
        };
        Returns: number;
      };
      whatsapp_messages_failed_outbound_to_followup_v1: {
        Args: {
        };
        Returns: unknown;
      };
      whatsapp_messages_touch_updated_at_v1: {
        Args: {
        };
        Returns: unknown;
      };
