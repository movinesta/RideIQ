...
Session 3 introduced durable webhook processing and a job queue:

- `20260203120000_webhook_job_queue.sql` — job queue tables + claim RPC.
- `20260203120500_webhook_jobs_updated_at_trigger.sql` — ensures `updated_at` is consistent for job state transitions.
